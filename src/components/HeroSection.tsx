  ...
  return (
    <Card className="mb-8 shadow-lg border-0">
      ...
      <CardContent className="py-[10px] px-[2px] my-0">
        <div onDragOver={handleDragOver} onDrop={handleDrop} className="border-2 border-dashed border-[#CCCCCC] rounded-lg p-8 text-center mb-6 transition-colors hover:border-[#AAAAAA] mx-[6px] py-[20px] my-[21px]">
